...
public class ConsolaOlimpicos
{
	...
	/**
	 * Le muestra al usuario el pais que representa el atleta seleccionado 
	 */
	private void ejecutarPaisAtleta()
	{
		...
		Map<String, String> paises = calculadora.paisAtleta();
		System.out.println("El pais que representa el atleta " +atleta+ " es: "+paises.get(atleta));
	}
